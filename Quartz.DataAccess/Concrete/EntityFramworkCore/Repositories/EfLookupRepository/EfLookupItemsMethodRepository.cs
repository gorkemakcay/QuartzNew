...
{
    public class EfLookupItemsMethodRepository : EfGenericRepository<LookUpItemsMethod>, ILookupItemsMethodDal
    {
        private readonly QuartzContext _ctx;
        public EfLookupItemsMethodRepository(QuartzContext ctx) : base(ctx)
        {
            _ctx = ctx;
        }
    }
