...
{
    public class EfLookupItemsFittingTypeRepository : EfGenericRepository<LookUpItemsFittingType>, ILookupItemsFittingTypeDal
    {
        private readonly QuartzContext _ctx;
        public EfLookupItemsFittingTypeRepository(QuartzContext ctx) : base(ctx)
        {
            _ctx = ctx;
        }
    }
