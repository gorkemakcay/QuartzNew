...
{
    public class EfLookupItemsSpecificationRepository : EfGenericRepository<LookUpItemsSpecification>, ILookupItemsSpecificationDal
    {
        private readonly QuartzContext _ctx;
        public EfLookupItemsSpecificationRepository(QuartzContext ctx) : base(ctx)
        {
            _ctx = ctx;
        }
    }
