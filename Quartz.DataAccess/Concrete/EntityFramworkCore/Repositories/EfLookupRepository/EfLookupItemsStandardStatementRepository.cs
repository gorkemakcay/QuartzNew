...
{
    public class EfLookupItemsStandardStatementRepository : EfGenericRepository<LookUpItemsStandardStatement>, ILookupItemsStandardStatementDal
    {
        private readonly QuartzContext _ctx;
        public EfLookupItemsStandardStatementRepository(QuartzContext ctx) : base(ctx)
        {
            _ctx = ctx;
        }
    }
