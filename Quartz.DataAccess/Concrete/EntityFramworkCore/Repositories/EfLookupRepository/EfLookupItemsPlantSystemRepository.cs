...
{
    public class EfLookupItemsPlantSystemRepository : EfGenericRepository<LookUpItemsPlantSystem>, ILookupItemsPlantSystemDal
    {
        private readonly QuartzContext _ctx;
        public EfLookupItemsPlantSystemRepository(QuartzContext ctx) : base(ctx)
        {
            _ctx = ctx;
        }
    }
