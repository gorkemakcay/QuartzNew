...
{
    public class EfLookupItemsProcedureRepository : EfGenericRepository<LookUpItemsProcedure>, ILookupItemsProcedureDal
    {
        private readonly QuartzContext _ctx;
        public EfLookupItemsProcedureRepository(QuartzContext ctx) : base(ctx)
        {
            _ctx = ctx;
        }
    }
