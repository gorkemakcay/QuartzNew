...
{
    public class EfLookupItemsTechniqueRepository : EfGenericRepository<LookUpItemsTechnique>, ILookupItemsTechniqueDal
    {
        private readonly QuartzContext _ctx;
        public EfLookupItemsTechniqueRepository(QuartzContext ctx) : base(ctx)
        {
            _ctx = ctx;
        }
    }
